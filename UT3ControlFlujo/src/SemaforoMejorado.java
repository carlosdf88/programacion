...
import graphics.Color;
	...
	public class SemaforoMejorado {	
		...
		public static void main(String[] args) throws InterruptedException {
			...
			rojo3.setColor(Color.WHITE);
			rojo3.fill();
			rojo4.setColor(Color.WHITE);
			rojo4.fill();
			rojo5.setColor(Color.WHITE);
			rojo5.fill();
			rojo6.setColor(Color.WHITE);
			rojo6.fill();
			rojo7.setColor(Color.WHITE);
			rojo7.fill();
			rojo8.setColor(Color.WHITE);
			rojo8.fill();
			rojo9.setColor(Color.WHITE);
			rojo9.fill();
			rojo10.setColor(Color.WHITE);
			rojo10.fill();
			rojo11.setColor(Color.WHITE);
			rojo11.fill();
			rojo12.setColor(Color.WHITE);
			rojo12.fill();
